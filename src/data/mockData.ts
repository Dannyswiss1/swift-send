import { User, Contact, Transaction, FundingMethod, WithdrawalMethod, Partner, PickupLocation } from '@/types';
...
export const partners: Partner[] = [
  {
    ...
    description: 'Mexico\'s largest convenience store chain with 20,000+ locations',
    countries: ['MX'],
    services: ['cash_out'],
    reliability: 0.98,
